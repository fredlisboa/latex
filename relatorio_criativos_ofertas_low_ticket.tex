...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{c X c}
        ...
        \rowcolor{lightGray}
        \textbf{Body} & GC natural: pessoa usando o app / fazendo ação + antes/depois no meio & 5-35s \\
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{X X}
        ...
        \rowcolor{lightGray}
        Estilo visual & 100\% orgânico / GC / TikTok \\
...
\begin{tikzpicture}[scale=0.9]
    % Teste 1
    \draw[fill=primaryColor!20, rounded corners] (0,0) rectangle (4.5,3);
    \node[text width=3.8cm, align=center] at (2.25,2.2) {\textbf{\textcolor{primaryColor}{TESTE 1}}};
    \node[text width=3.8cm, align=center] at (2.25,1.5) {\textbf{Estrutura}};
    \node[text width=3.8cm, align=center, font=\small] at (2.25,0.7) {ABO 1-1-1\\ABO 1-3-1\\CBO 1-3-3\\etc.};

    % Teste 2
    \draw[fill=accentColor!15, rounded corners] (5,0) rectangle (9.5,3);
    \node[text width=3.8cm, align=center] at (7.25,2.2) {\textbf{\textcolor{accentColor}{TESTE 2}}};
    \node[text width=3.8cm, align=center] at (7.25,1.5) {\textbf{Orçamento}};
    \node[text width=3.8cm, align=center, font=\small] at (7.25,0.7) {R\$17 (baixo)\\Valor do ticket\\3x o ticket};

    % Teste 3
    \draw[fill=successGreen!15, rounded corners] (10,0) rectangle (14.5,3);
    \node[text width=3.8cm, align=center] at (12.25,2.2) {\textbf{\textcolor{successGreen}{TESTE 3}}};
    \node[text width=3.8cm, align=center] at (12.25,1.5) {\textbf{Conta de Anúncio}};
    \node[text width=3.8cm, align=center, font=\small] at (12.25,0.7) {Conta A\\Conta B\\(mesmo criativo)};

    % Setas
    \draw[->, ultra thick, primaryColor] (4.5,1.5) -- (5,1.5);
    \draw[->, ultra thick, primaryColor] (9.5,1.5) -- (10,1.5);
\end{tikzpicture}
\end{center}
...
\begin{enumerate}
    ...
    \item Produza 3-5 criativos de até 50 segundos (orgânico/GC)
