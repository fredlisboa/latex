...
\hypersetup{
    ...
    pdftitle={Framework de Escala - Tráfego Pago Low Ticket 2026},
    pdfauthor={Heitor Nogueira}
}

% --- Configurações de Layout ---
\geometry{left=2.5cm, right=2.5cm, top=2cm, bottom=2.5cm, headsep=1cm, headheight=60pt}
...
% Rodapé
\fancyfoot[L]{\scriptsize \textcolor{secondaryText}{Mentoria: \textbf{Heitor Nogueira} | @heitornogueirama}}
...
\begin{titlepage}
    ...
    % Box de Créditos do Mentor
    \colorbox{accentColor}{%
        \parbox{0.9\textwidth}{%
            \centering
            \textcolor{white}{\vspace{0.6cm}}
            \textcolor{white}{\Large \textbf{MENTOR: HEITOR NOGUEIRA}} \\
            \textcolor{white}{\vspace{0.2cm}}
            \textcolor{white}{\normalsize YouTube: \textbf{@heitornogueirama} | 8.4K inscritos} \\
            \textcolor{white}{\normalsize Instagram: \textbf{instagram.com/heitornogueirama}} \\
            \textcolor{white}{\vspace{0.6cm}}
        }%
    }
...
\begin{center}
    {\Huge \textcolor{primaryColor}{\textbf{SOBRE O MENTOR}}} \\
    \vspace{1cm}
    \rule{12cm}{1.5pt}
    \vspace{1cm}
    ...
    \colorbox{accentColor}{%
        \parbox{0.92\textwidth}{%
            \centering
            \textcolor{white}{\vspace{0.8cm}}
            \textcolor{white}{\Huge \textbf{HEITOR NOGUEIRA}} \\
            \textcolor{white}{\vspace{0.3cm}}
            \textcolor{white}{\Large Especialista em Growth Marketing \& Tráfego Pago} \\
            \textcolor{white}{\vspace{0.8cm}}
        }%
    }
    ...
    \textbf{YouTube:} \\
    \vspace{0.3cm}
    \hspace{1cm} \textcolor{accentColor}{\Large \textbf{@heitornogueirama}} \\
    \hspace{1cm} \textcolor{secondaryText}{8.4K inscritos | 244 vídeos} \\
    \hspace{1cm} \textcolor{secondaryText}{Conteúdo sobre Tráfego Pago, Low Ticket e Marketing Digital} \\
    ...
    \vspace{0.3cm}
    \hspace{1cm} \textcolor{accentColor}{\Large \textbf{@heitornogueirama}} \\
    \hspace{1cm} \textcolor{secondaryText}{\url{https://instagram.com/heitornogueirama}} \\

    \vspace{1cm}

    \textbf{Mentoria Ou Processo:} \\
    \vspace{0.3cm}
    \hspace{1cm} \textcolor{secondaryText}{Metodologia MVT completa para produtos digitais Low Ticket} \\
    \hspace{1cm} \textcolor{secondaryText}{Acompanhamento ao vivo 2x por semana} \\
    \hspace{1cm} \textcolor{secondaryText}{Frameworks, templates e suporte via Discord/WhatsApp} \\
    \end{flushleft}
    ...
    \colorbox{lightGray}{%
        \parbox{0.9\textwidth}{%
            \centering
            \vspace{0.4cm}
            \textcolor{primaryColor}{\large \textbf{``Cristão, Casado, Pai da Laura''}} \\
            \vspace{0.2cm}
            \textcolor{secondaryText}{\normalsize Construindo negócios digitais escaláveis e sustentáveis} \\
            \vspace{0.4cm}
        }%
    }
    ...
    \textcolor{secondaryText}{\footnotesize Framework compilado em 07 de Janeiro de 2026} \\
    \textcolor{secondaryText}{\footnotesize Baseado em transcrição de conteúdo original do canal @heitornogueirama}
